...
=====================
'''
SOH         = chr(0x01)  # Indicates a packet length of 128 (X/Y)
STX         = chr(0x02)  # Indicates a packet length of 1024 (X/Y)
EOT         = chr(0x04)  # End of transmission (X/Y)
ACK         = chr(0x06)  # Acknowledgement (X/Y)
XON         = chr(0x11)  # Enable out of band flow control (Z)
XOFF        = chr(0x13)  # Disable out of band flow control (Z)
NAK         = chr(0x15)  # Negative acknowledgement (X/Y)
CAN         = chr(0x18)  # Cancel (X/Y)
CRC         = chr(0x43)  # Cyclic redundancy check (X/Y)
...
=====================
'''
TIMEOUT     = None  # Timeout or invalid data.
ZPAD        = 0x2a  # Pad character; frame begins
ZDLE        = 0x18  # Escape sequence
ZDLEE       = 0x58  # Escaped ``ZDLE``
ZBIN        = 0x41  # Binary frame indicator (using CRC16)
ZHEX        = 0x42  # Hex frame indicator (using CRC16)
ZBIN32      = 0x43  # Binary frame indicator (using CRC32)
ZBINR32     = 0x44  # Run length encoded binary frame (using CRC32)
ZVBIN       = 0x61  # Binary frame indicator (using CRC16)
ZVHEX       = 0x62  # Hex frame indicator (using CRC16)
ZVBIN32     = 0x63  # Binary frame indicator (using CRC32)
ZVBINR32    = 0x64  # Run length encoded binary frame (using CRC32)
ZRESC       = 0x7e  # Run length encoding flag or escape character
...
ZF0_CANCRY  = 0x08  # Receiver can decrypt DON'T USE TODO: why unusable?!
ZF0_CANLZW  = 0x10  # Receiver can uncompress DON'T USE TODO: why unusable?!
